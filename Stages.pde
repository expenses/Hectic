...
Stage stageOne() {
    ...
    stage.add(25, new Gargoyle(new FiringMove(0.50, 5, 100), new AtPlayer(3, 1, 2)));
    stage.add(25, new Gargoyle(new FiringMove(0.25, 5, 100), new AtPlayer(3, 1, 2)));
    stage.add(25, new Gargoyle(new FiringMove(0.75, 5, 100), new AtPlayer(3, 1, 2)));
